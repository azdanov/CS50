...
def chart(positive, negative, neutral):
        ...
        "data": [
            {
                ...
                "hoverinfo": "none",
                "marker": {
                    "colors": ["rgb(0,255,00)", "rgb(255,0,0)", "rgb(255,255,0)"]
                },
                "type": "pie",
    ...
    return plotly.offline.plot(
        figure, output_type="div", show_link=False, link_text=False
    )
...
def get_tweets_stats(tweets):
    """
    Analyze tweets list for positive, negative and neutral and return overall stats
    :param tweets: list containing tweets
    :return: tuple with positive, negative and neutral score integers
    """
